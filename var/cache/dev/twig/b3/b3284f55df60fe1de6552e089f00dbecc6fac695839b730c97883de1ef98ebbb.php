...
class __TwigTemplate_9db8b8034d8c0d77960c1b3076581e4a4674d4278567665815f9a9739a331bd9 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
<?php if (\$required): ?> required=\"required\"<?php endif ?>
<?php echo \$attr ? ' '.\$view['form']->block(\$form, 'attributes') : '' ?>", "@Framework/Form/widget_attributes.html.php", "/var/www/html/BookApp/vendor/symfony/framework-bundle/Resources/views/Form/widget_attributes.html.php");
    }
}
