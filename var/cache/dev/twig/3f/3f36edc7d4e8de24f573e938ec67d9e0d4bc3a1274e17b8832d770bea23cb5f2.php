...
class __TwigTemplate_5991941e3c1528bc0bebff25a6ee65e3c403582e34d6eddfa3dcbf4ae5a351b9 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
<label<?php if (\$label_attr) { echo ' '.\$view['form']->block(\$form, 'attributes', ['attr' => \$label_attr]); } ?>><?php echo \$view->escape(false !== \$translation_domain ? \$view['translator']->trans(\$label, \$label_translation_parameters, \$translation_domain) : \$label) ?></label>
<?php endif ?>
", "@Framework/Form/form_label.html.php", "/var/www/html/BookApp/vendor/symfony/framework-bundle/Resources/views/Form/form_label.html.php");
    }
}
